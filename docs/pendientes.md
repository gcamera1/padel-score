...
### Release 5 — Wear OS 1.2.0: fix del crash en Android 16 · ✅ PUBLICADA (Envío 19, 07/09/2026)
...
**Enviada el 02/09/2026 12:38 como Envío 19 y publicada el 07/09/2026** — Producción
(Wear OS), lanzamiento completo 100%, un único ítem en el envío. El `350110203` quedó en
"No incluido". 81 wearables compatibles, 0 dejan de serlo.

Seguimiento post-release: mirar Android vitals en ~2 semanas y confirmar que el contador de
